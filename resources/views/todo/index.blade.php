                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <form action="{{ route('checklists.update', $checklist) }}" method="POST"
                                            ...
                                            <input type="text" name="title" class="editable-input text-truncate"
                                                size="50" maxlength="50" value="{{ Str::title($checklist->title) }}"
                                                required>
                                        </form>
                                        <span
                                            class="badge text-bg-{{ $checklist->is_all_complete ? 'success' : 'secondary' }}">
                                    ...
                                    <div class="card-body">
                                        <form class="mb-3" method="POST" action="{{ route('items.store') }}">
                                            ...
                                            <div class="input-group input-group-sm"
                                                {{ $checklist->is_all_complete ? 'hidden' : '' }}>
                                                ...
                                                <li class="list-group-item position-relative">
                                                    ...
                                                    @if ($item->user->is(auth()->user()))
                                                        <div {{ $item->is_complete ? 'hidden' : '' }}
                                                            ...
                                                            <form class="float-end" method="POST" id="delete_item"
